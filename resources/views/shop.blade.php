<x-layout>
    ...
    <main class="w-full mx-auto flex flex-col gap-8 py-6 px-4 max-w-screen-lg">
  
      <section class="relative shop-banner">
        <img src="{{ asset('images/banners/shopping-banner.png') }}" alt="Shop banner" class="w-full h-48 md:h-full object-cover">
        <div class="absolute bottom-0 top-20 left-0 w-full bg-gradient-to-t from-white to-transparent flex items-end justify-center pb-4 md:pb-10">
          <p class="text-xl text-center font-montserrat font-semibold p-3 xs:p-0">Hurry, Limited Stock Available - <span class="text-red-700">Shop Today!</span></p>
        </div>
      </section>
